                ...
                <div className="showcaselayout">
                    <div className="first-project-wrapper showcase-card">
                        <div>
                            ...
                            <Image src="/images/project (7).png" className="object-contain" alt="Fitness platform" loading="lazy" width={100} height={100}  />
                            </a>
                        </div>
                    ...
                    <div className="project-list-wrapper overflow-hidden">
                        <div className="project showcase-card">
                            <div className=''>
                                <a href="https://tswatchables.netlify.app/" target="_blanck">
                                    <Image src="/images/project.png" alt="Movie App" className='image-wrapper bg-[#ffe7eb] py-2' loading="lazy" width={100} height={100}  />
                                </a>
                            </div>
                            <h2>Movie web App</h2>
                        </div>
                        <div className="project showcase-card">
                            <div className='image-wrapper bg-[#ffe7eb] py-2'>
                                ...
                                <Image src="/images/preview.png" alt="Getlinked prehackathon" loading="lazy" width={100} height={100}  />
                                </a>
                            </div>
                    ...
                    <div className='project'>
                        <div className="image-wrapper bg-[#ffe7eb] p-5 rounded-xl">
                            <a href="https://fe-mal.netlify.app" target="_blank">
                                <Image src="/images/project (2).png" className=' object-fill' alt="Ecommerce" loading="lazy" width={100} height={100}  />
                            </a>
                        </div>
                    ...
                    <div className='project'>
                        <div className="image-wrapper bg-[#ffe7eb] p-5 rounded-xl">
                            <a href="https://devtsocialbook.netlify.app" target="_blank">
                                <Image src="/images/project (1).png" className=' object-fill' alt="Socialbook" loading="lazy" width={100} height={100}  />
                            </a>
                        </div>
                    ...
                    <div className='project'>
                        <div className="image-wrapper bg-[#ffe7eb] p-5 rounded-xl">
                            <a href="https://animately.netlify.app" target="_blank">
                                <Image src="/images/project (8).png" className=' object-fill' alt="Animately" loading="lazy" width={100} height={100}  />
                            </a>
                    ...
                    <div className='project'>
                        <div className="image-wrapper bg-[#ffe7eb] p-5 rounded-xl">
                            <a href="https://neebo.netlify.app" target="_blank">
                                <Image src="/images/project (9).png"  className=' object-fill' alt="Ecommerce" loading="lazy" width={100} height={100}  />
                            </a>
                        </div>
